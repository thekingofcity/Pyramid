...
class Token:
    ...
    def _get_token_key(self):
        ...
        # ====== Modified by thekingofcity ======
        proxy = {
            "http": "http://192.168.2.107:1080",
            "https": "https://192.168.2.107:1080"
        }
        try:
            response = requests.get("https://translate.google.com/", proxies=proxy, timeout=1)
        except requests.exceptions.Timeout as err:
            raise Exception("Timeout GFW")
        # ====== Modified by thekingofcity ======
